...
# speciesA_file = "/dors/capra_lab/abraha1/projects/transposable_elements/data/tf_dynamics/comparative/MER20/fasta_files/hg19_MER20.fa"
# speciesB_file = "/dors/capra_lab/abraha1/projects/transposable_elements/data/tf_dynamics/comparative/MER20/fasta_files/mm9_MER20.fa"
...
enrich_output_file_path = file.path(output_file_path, paste("output", output_header, "enrichment_motifDiverge.tsv", sep=""))
deplete_output_file_path = file.path(output_file_path, paste("output", output_header, "deplete_motifDiverge.tsv", sep=""))
